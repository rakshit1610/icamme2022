...
function Call() {
  return (
    ...
    <div className="container mt-5 mb-5">
      ...
      <div className='row'>
      <div className='col-12 mb-2 col-md-6'><p className='itemboxes m-0 p-2'>Full Paper Submission Deadline : <span style={{"text-decoration": "line-through"}}>25 Nov’ 2021</span> 8 Dec' 2021 </p></div>
