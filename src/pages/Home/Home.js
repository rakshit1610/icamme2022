...
function Home() {
  ...
  return (
    ...
    <div className="container mt-5">
      ...
      <p>An online peer reviewed international conference on Advances in Materials and Mechanical Engineering (ICAMME-2022) is scheduled to be held during (18-19 Feb’ 2022) at Ajay Kumar Garg Engineering College, Ghaziabad, Uttar Pradesh, India. ICAMME-2022 seeks to provide an open communication platform to discuss and exchange futuristic trends and high-quality research in the field of Materials and Mechanical Engineering among researchers, academicians, industrial professionals and students and also bring together people from all different geographical areas who share a common discipline or field. The primary goal of the conference is to promote research and development activities needed for the next generation and focused on all promising areas of Materials and Mechanical Engineering. Several renowned experts from the Materials and Mechanical Engineering will share their knowledge and experience with the participants.</p>
    </div>
